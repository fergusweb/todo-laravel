    ...
    <form method="POST" action="/jobs">
        ...
        <div class="mb-4">
            ...
            <textarea id="taskDescription" name="taskDescription" rows="4"
                class="mt-1 p-2 w-full border rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"></textarea>
        </div>
        ...
        <fieldset id="taskItems">
            ...
            <div class="task-item mb-6">
                ...
                <div class="mb-4">
                    <label for="itemDescription" class="block text-sm font-medium text-gray-700">Item
                        Description</label>
                ...
                <button type="button" class="text-red-600 hover:text-red-900 remove-item">Remove Item</button>
            </div>
        </fieldset>

        <button type="button" class="text-indigo-600 hover:text-indigo-900 mb-6" id="addItem">+ Add Another
            Item</button>

        <div class="mt-6">
            <button type="submit"
                class="bg-indigo-600 text-white py-2 px-4 rounded-md shadow-sm hover:bg-indigo-700">Submit</button>
        </div>
        <script>
